...
parser.add_argument('--dataset', type=str, default='VOT2018',
        help='datasets')
parser.add_argument('--config', default='siamban_r50_l234_otb/config.yaml', type=str,
        help='config file')
parser.add_argument('--snapshot', default='siamban_r50_l234/snapshot/checkpoint_e19.pth', type=str,
    ...
    if args.dataset in ['VOT2016', 'VOT2018', 'VOT2019']:
        ...
        for v_idx, video in enumerate(dataset):
            ...
            if 'VOT2018-LT' == args.dataset or 'VOT2019-LT' == args.dataset:
                ...
                model_path = os.path.join('results', args.dataset, exp_name, model_name)
